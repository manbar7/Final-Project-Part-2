...
namespace WebApplication1.Controllers
{
    ...
    {
        static List <AirlineCompany> airlineCompanies = new List<AirlineCompany>();
        ...
        public AirlineCompanyFacadeController()
        {
            ...
            airlineCompanies.Add(new AirlineCompany { AIRLINE_ID = 1, AIRLINE_NAME = "Arkia", COUNTRY_CODE = 2, USERNAME = "arkia", PASSWORD = "arkia" });
            airlineCompanies.Add(new AirlineCompany { AIRLINE_ID = 2, AIRLINE_NAME = "El Al", COUNTRY_CODE = 2, USERNAME = "elal", PASSWORD = "elal" });
            airlineCompanies.Add(new AirlineCompany { AIRLINE_ID = 3, AIRLINE_NAME = "Turkish", COUNTRY_CODE = 5, USERNAME = "turkish", PASSWORD = "turkish" });
        }
